...
public class LegacyGraylogSearch {
    ...
    public LegacyGraylogSearch(
        ...
        this.legacySearchAbsolute = legacySearchAbsolute;
    }
    ...
    public List<?> getMessages(
        ...
        List<Map<String, Map<String, ?>>> messageMapList = legacySearchAbsolute.getMessages(
    ...
    public Page<?> getMessages(
        ...
        MessageList messageList = legacySearchAbsolute.getMessages(
            StringUtils.join(fieldList, ","),
            query,
            from,
            to,
    ...
    public Statistics getStatistics(
        ...
        return legacySearchAbsolute.getStatistics(field, query, from, to, filter);
    }
    ...
    public Histogram getHistogram(
        ...
        return legacySearchAbsolute.getHistogram(query, interval, from, to, filter);
    }
    ...
    public FieldHistogram getFieldHistogram(
        ...
        return legacySearchAbsolute.getFieldHistogram(field, query, interval, from, to, filter);
    }
    ...
    public Terms getTerms(
        ...
        return legacySearchAbsolute.getTerms(
            field,
            stackedFields,
            query,
            from,
